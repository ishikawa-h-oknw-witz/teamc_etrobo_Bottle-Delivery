...
LineTraceScene lineTraceScenes[] =
{
    ...
    {15, 1100, 100, RunnerEdge::LeftEdge,  Color::None, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f} }, // Dlv直線1
    {16,  200,  30, RunnerEdge::LeftEdge,  Color::None, CalibrationData::BlackWhiteCenter, {0.6f, 0.0f, 0.4f} }, // Dlvカーブ3
    {17,    0, 100, RunnerEdge::LeftEdge,  Color::Blue, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f} }, // Dlv青まで
    {18,  400, 100, RunnerEdge::RightEdge, Color::None, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f} }, // Dlv帰還直線1
    {20,  300,  60, RunnerEdge::RightEdge, Color::None, CalibrationData::BlackWhiteCenter, {0.6f, 0.0f, 0.4f} }, // Dlv帰還カーブ1
    {21,    0, 100, RunnerEdge::RightEdge, Color::Blue, CalibrationData::BlackWhiteCenter, {0.3f, 0.0f, 0.4f} }  // Dlv帰還青まで
};
